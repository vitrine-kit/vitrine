...
- 665d0e3: Security hardening from an OWASP-style review of generated stores:
...
- 394587f: `<Slot>` uses stable React keys (component name + occurrence) instead of the array index —
